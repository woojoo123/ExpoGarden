# ExpoGarden - 메타버스 쇼룸 플랫폼

Phaser.js와 Spring Boot 기반의 개인 메타버스 쇼룸 플랫폼입니다.

## 📋 프로젝트 개요

**ExpoGarden**은 포트폴리오, 작품 갤러리, 프로젝트 쇼케이스를 2D 메타버스에 전시할 수 있는 플랫폼입니다.
- 창작자는 3분 만에 자신의 쇼룸을 만들고 작품을 전시합니다
- 방문자는 캐릭터를 조작하며 메타버스 공간을 걸어다니며 쇼룸을 관람합니다
- 실시간 채팅, 방명록, 질문 등으로 창작자와 방문자가 소통합니다
